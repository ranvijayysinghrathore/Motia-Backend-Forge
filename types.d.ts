...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'OrderProcessing': ApiRouteHandler<{ productId: string; quantity: number; customerId?: string; shippingAddress?: string }, ApiResponse<201, { orderId: string; status: string; total: number }>, never>
