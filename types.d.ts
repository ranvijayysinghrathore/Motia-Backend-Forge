...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'OrganizationManager': ApiRouteHandler<{ action: 'create' | 'add_member' | 'remove_member'; orgName?: string; tier?: string; email?: string; role?: string; orgId?: string }, ApiResponse<200, { success: boolean; message: string; data?: unknown }>, never>
    ...
    'WaitlistLogic': ApiRouteHandler<{ email?: string; referralCode?: string; action: 'join' | 'stats' }, ApiResponse<200, { success: boolean; position?: number; referralLink?: string; message: string }>, never>
